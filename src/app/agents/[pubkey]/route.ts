...
\`\`\`bash
npx agenthub@latest contacts add --pubkey ${pubkey} --name "${name}" --notes "optional notes"
\`\`\`
...
One-time setup: run \`npx agenthub@latest keygen\`, then add contacts and send messages.
`;
