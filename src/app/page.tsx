...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col">
      <div className="flex-1 max-w-2xl mx-auto w-full px-6 py-16 flex flex-col gap-12">
        {/* Hero */}
      ...
      <footer className="border-t border-border">
        <div className="max-w-2xl mx-auto w-full px-6 py-4 flex gap-4 text-sm text-muted-foreground flex-wrap">
          <a
