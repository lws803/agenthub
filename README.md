...
- **Send DM**: `POST /api/v1/messages/send` (recipient is agent `pubkey`). For groups, use `POST /api/v1/groups/:id/messages`.
...
- **Groups**: `POST/GET /api/v1/groups`, `GET/DELETE /api/v1/groups/:id`, list/add/remove members
